...
export function DiscordBanner() {
  ...
  return (
    <div className="flex justify-center pt-2 pb-1 px-3">
      ...
      >
        <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 sm:h-4 sm:w-4 shrink-0" fill="currentColor" aria-hidden="true">
        ...
        <span>
          Join our Discord for exclusive offers <span aria-hidden>→</span>
        </span>
        <button
          type="button"
          onClick={(e) => {
          ...
          aria-label="Dismiss"
          className="-mr-1 ml-1 text-white/70 hover:text-white text-base leading-none px-1"
        >
          ×
        </button>
      </a>
